...
<script>
	var oTable;
	$(function(){
		oTable = $('#lawDocListTable').dataTable({
			...
			<div class="col-md-9">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">法律法规档案管理</h3>
					</div>
				  	<div class="panel-body">
				  		<div class="row">
				  			<div class="col-sm-12">
						  		<div class="btn-group">
						  		  <a id="createBtn" href="${context}/document/law/create" class="btn btn-primary" role="button">创建</a>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="dataTableContainer">
									<table id="lawDocListTable" class="datatable table table-striped table-bordered">
									    <thead>
									        <tr>
									            <th>法律法规编号</th>
									            <th>法律法规名称</th>
